...
type AuditTrailModel struct {
	...
	CreateAt time.Time `bun:"create_at,nullzero,notnull,default:current_timestamp" json:"create_at"`
	UpdateBy string    `bun:"update_by" json:"update_by"`
	UpdateAt time.Time `bun:"update_at,nullzero,default:current_timestamp" json:"update_at"`
